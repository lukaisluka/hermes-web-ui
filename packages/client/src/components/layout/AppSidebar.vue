    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('system')" class="nav-group-items">
          ...
          <RouteLinkItem v-if="isProfileAdmin && appStore.terminalEnabled" class="nav-item" :to="{ name: 'poiera.terminal' }" :active="selectedKey === 'poiera.terminal'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem v-if="isProfileAdmin" class="nav-item" :to="{ name: 'poiera.audit' }" :active="selectedKey === 'poiera.audit'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
