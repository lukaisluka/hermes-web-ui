export default {
  ...
  audit: {
    ...
    filterAction: '작업으로 필터',
    filterProfile: 'Profile로 필터',
    filterTargetType: '대상 유형으로 필터',
    filterDateRange: '날짜 범위',
    apply: '적용',
    reset: '재설정',
    fetchError: '감사 이벤트 가져오기 실패',
    verifyError: '체인 무결성 검증 실패',
    exportError: '감사 이벤트 내보내기 실패',
    integrityDesc: '감사 로그 해시 체인의 무결성을 검증합니다. 각 이벤트는 SHA-256으로 이전 이벤트에 연결되어 변조를 감지할 수 있습니다.',
    verifyChain: '체인 검증',
    export: 'JSON 내보내기',
    chainValid: '체인 무결성 검증 통과',
    chainBroken: '체인 무결성이 손상되었습니다!',
    brokenAt: '이벤트 ID {id}에서 체인이 끊겼습니다',
  },
}
