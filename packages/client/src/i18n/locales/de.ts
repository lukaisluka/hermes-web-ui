...
jobTriggered: 'Job ausgelost',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Desktop-Download-Links sind jetzt auf der offiziellen Website https://github.com/lukaisluka/poiera verfügbar, aktuelle Installer bleiben außerdem über GitHub Releases verfügbar',
  ...
  audit: {
    ...
    filterProfile: 'Nach Profile filtern',
    filterTargetType: 'Nach Zieltyp filtern',
    filterDateRange: 'Datumsbereich',
    apply: 'Anwenden',
    reset: 'Zurücksetzen',
    fetchError: 'Audit-Ereignisse konnten nicht abgerufen werden',
    verifyError: 'Chain-Integrität konnte nicht verifiziert werden',
    exportError: 'Audit-Ereignisse konnten nicht exportiert werden',
    integrityDesc: 'Überprüfen Sie die Integrität der Audit-Log-Hash-Chain. Jedes Ereignis ist über SHA-256 mit dem vorherigen verknüpft, sodass Rückwärtsänderungen erkennbar sind.',
    verifyChain: 'Chain verifizieren',
    export: 'JSON exportieren',
    chainValid: 'Chain-Integrität verifiziert',
    chainBroken: 'Chain-Integrität beschädigt!',
    brokenAt: 'Chain beschädigt bei Ereignis-ID: {id}',
  },
}
