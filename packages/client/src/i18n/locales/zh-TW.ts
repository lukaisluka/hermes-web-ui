export default {
  ...
  changelog: {
    ...
    new_0_6_7_9: '桌面端下載入口已補充到官網 https://github.com/lukaisluka/poiera，也可以繼續從 GitHub Releases 取得最新安裝包',
  ...
  audit: {
    ...
    noEvents: '未找到審計事件',
    filterAction: '按操作篩選',
    filterProfile: '按 Profile 篩選',
    filterTargetType: '按目標類型篩選',
    filterDateRange: '日期範圍',
    apply: '套用',
    reset: '重設',
    fetchError: '取得審計事件失敗',
    verifyError: '驗證鏈完整性失敗',
    exportError: '匯出審計事件失敗',
    integrityDesc: '驗證審計日誌哈希鏈的完整性。每個事件透過 SHA-256 連結到前一個事件，使回溯修改可被偵測。',
    verifyChain: '驗證鏈',
    export: '匯出 JSON',
    chainValid: '鏈完整性驗證通過',
    chainBroken: '鏈完整性已破壞！',
    brokenAt: '鏈在事件 ID {id} 處斷開',
  },
}
