export default {
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Desktop download links are now available on the official website at https://github.com/lukaisluka/poiera, and the latest installers remain available from GitHub Releases',
  ...
  audit: {
    ...
    apply: 'Apply',
    reset: 'Reset',
    fetchError: 'Failed to fetch audit events',
    verifyError: 'Failed to verify chain integrity',
    exportError: 'Failed to export audit events',
    integrityDesc: 'Verify the integrity of the audit log hash chain. Each event is linked to the previous one via SHA-256, making retroactive modification detectable.',
    verifyChain: 'Verify Chain',
    export: 'Export JSON',
    chainValid: 'Chain integrity verified',
    chainBroken: 'Chain integrity broken!',
    brokenAt: 'Chain broken at event ID: {id}',
  },
}
