export default {
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Desktop download links are now available on the official website at https://github.com/lukaisluka/hermes-web-ui, and the latest installers remain available from GitHub Releases',
