export default {
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Desktop のダウンロードリンクを公式サイト https://github.com/lukaisluka/poiera に追加し、最新インストーラーは引き続き GitHub Releases からも取得できます',
  ...
  audit: {
    ...
    detail: '詳細',
    eventDetail: 'イベント詳細',
    noEvents: '監査イベントが見つかりません',
    filterAction: 'アクションで絞り込み',
    filterProfile: 'Profile で絞り込み',
    filterTargetType: '対象タイプで絞り込み',
    filterDateRange: '日付範囲',
    apply: '適用',
    reset: 'リセット',
    fetchError: '監査イベントの取得に失敗しました',
    verifyError: 'チェーン整合性の検証に失敗しました',
    exportError: '監査イベントのエクスポートに失敗しました',
    integrityDesc: '監査ログのハッシュチェーン整合性を検証します。各イベントは SHA-256 で前のイベントにリンクされ、改ざんを検出できます。',
    verifyChain: 'チェーン検証',
    export: 'JSON エクスポート',
    chainValid: 'チェーン整合性が検証されました',
    chainBroken: 'チェーン整合性が破損しています！',
    brokenAt: 'イベント ID {id} でチェーンが断裂しています',
  },
}
