...
jobTriggered: 'Job acionado',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Links de download do desktop agora estão disponíveis no site oficial https://github.com/lukaisluka/poiera, e os instaladores mais recentes continuam disponíveis no GitHub Releases',
  ...
  audit: {
    ...
    filterProfile: 'Filtrar por Profile',
    filterTargetType: 'Filtrar por tipo de destino',
    filterDateRange: 'Intervalo de datas',
    apply: 'Aplicar',
    reset: 'Redefinir',
    fetchError: 'Falha ao buscar eventos de auditoria',
    verifyError: 'Falha ao verificar integridade da cadeia',
    exportError: 'Falha ao exportar eventos de auditoria',
    integrityDesc: 'Verifique a integridade da cadeia de hash do log de auditoria. Cada evento é vinculado ao anterior via SHA-256, permitindo detectar modificações retroativas.',
    verifyChain: 'Verificar cadeia',
    export: 'Exportar JSON',
    chainValid: 'Integridade da cadeia verificada',
    chainBroken: 'Integridade da cadeia comprometida!',
    brokenAt: 'Cadeia rompida no evento ID: {id}',
  },
}
