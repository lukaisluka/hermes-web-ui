...
jobTriggered: 'Job ejecutado',
  ...
  audit: {
    ...
    apply: 'Aplicar',
    reset: 'Restablecer',
    fetchError: 'Error al obtener eventos de auditoría',
    verifyError: 'Error al verificar la integridad de la cadena',
    exportError: 'Error al exportar eventos de auditoría',
    integrityDesc: 'Verifique la integridad de la cadena de hash del registro de auditoría. Cada evento se vincula al anterior mediante SHA-256, lo que permite detectar modificaciones retroactivas.',
    verifyChain: 'Verificar cadena',
    export: 'Exportar JSON',
    chainValid: 'Integridad de la cadena verificada',
    chainBroken: 'Integridad de la cadena comprometida!',
    brokenAt: 'Cadena rota en evento ID: {id}',
  },
}
