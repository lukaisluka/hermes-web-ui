export default {
  ...
  audit: {
    ...
    noEvents: '未找到审计事件',
    filterAction: '按操作筛选',
    filterProfile: '按 Profile 筛选',
    filterTargetType: '按目标类型筛选',
    filterDateRange: '日期范围',
    apply: '应用',
    reset: '重置',
    fetchError: '获取审计事件失败',
    verifyError: '验证链完整性失败',
    exportError: '导出审计事件失败',
    integrityDesc: '验证审计日志哈希链的完整性。每个事件通过 SHA-256 链接到前一个事件，使回溯修改可被检测。',
    verifyChain: '验证链',
    export: '导出 JSON',
    chainValid: '链完整性验证通过',
    chainBroken: '链完整性已破坏！',
    brokenAt: '链在事件 ID {id} 处断开',
  },
}
