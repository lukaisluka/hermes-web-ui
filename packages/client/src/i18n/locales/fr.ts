...
jobTriggered: 'Job declenche',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Les liens de téléchargement desktop sont maintenant disponibles sur le site officiel https://github.com/lukaisluka/poiera, et les derniers installateurs restent disponibles via GitHub Releases',
  ...
  audit: {
    ...
    filterProfile: 'Filtrer par Profile',
    filterTargetType: 'Filtrer par type de cible',
    filterDateRange: 'Plage de dates',
    apply: 'Appliquer',
    reset: 'Réinitialiser',
    fetchError: 'Échec de la récupération des événements d\'audit',
    verifyError: 'Échec de la vérification de l\'intégrité de la chaîne',
    exportError: 'Échec de l\'exportation des événements d\'audit',
    integrityDesc: 'Vérifiez l\'intégrité de la chaîne de hachage du journal d\'audit. Chaque événement est lié au précédent via SHA-256, rendant les modifications rétroactives détectables.',
    verifyChain: 'Vérifier la chaîne',
    export: 'Exporter JSON',
    chainValid: 'Intégrité de la chaîne vérifiée',
    chainBroken: 'Intégrité de la chaîne compromise !',
    brokenAt: 'Chaîne rompue à l\'événement ID : {id}',
  },
}
